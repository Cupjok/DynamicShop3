...
public final class LangUtil
{
    ...
    public static void setupLangFile(String lang)
    {
        // 한국어
        {
            ...
            ccLang.get().addDefault("SHOP.SELL_TAX_INFO", "§7({sign}세금 {num}%)");
            ...
            ccLang.get().addDefault("RANDOM_PRICE.TITLE", "§3랜덤 가격");
            ccLang.get().addDefault("RANDOM_PRICE.BUTTON", "§f랜덤 가격");
            ccLang.get().addDefault("RANDOM_PRICE.BUTTON_LORE", "§f가격을 정해진 퍼센트 범위에서 무작위로 올리거나 내림");
            ccLang.get().addDefault("RANDOM_PRICE.BACK", "§f돌아가기");
            ccLang.get().addDefault("RANDOM_PRICE.BACK_LORE", "§f§n클릭: 상점 설정으로");
            ccLang.get().addDefault("RANDOM_PRICE.ENABLE", "§f랜덤 가격 사용");
            ccLang.get().addDefault("RANDOM_PRICE.ENABLE_LORE", "§f켜면 상품마다 무작위 퍼센트가 적용됨");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET", "§f적용 대상");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_LORE", "§f구매가/판매가 중 어디에 적용할지");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_BUY", "구매만");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_SELL", "판매만");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_BOTH", "구매와 판매 둘 다");
            ccLang.get().addDefault("RANDOM_PRICE.MIN", "§f최소 퍼센트");
            ccLang.get().addDefault("RANDOM_PRICE.MIN_LORE", "§f무작위 범위의 최솟값 (음수 = 할인)");
            ccLang.get().addDefault("RANDOM_PRICE.MAX", "§f최대 퍼센트");
            ccLang.get().addDefault("RANDOM_PRICE.MAX_LORE", "§f무작위 범위의 최댓값");
            ccLang.get().addDefault("RANDOM_PRICE.REROLL", "§f지금 다시 뽑기");
            ccLang.get().addDefault("RANDOM_PRICE.REROLL_LORE", "§e클릭: 이 상점의 모든 상품 퍼센트를 다시 뽑음");
            ccLang.get().addDefault("RANDOM_PRICE.REROLLED", "§f랜덤 가격을 다시 뽑았습니다. 상점: {shop}");
            ccLang.get().addDefault("RANDOM_PRICE.NOT_ENABLED", "§f이 상점은 랜덤 가격 기능이 꺼져 있습니다. 상점: {shop}");
            ccLang.get().addDefault("RANDOM_PRICE.TIMER", "§f예약 초기화");
            ccLang.get().addDefault("RANDOM_PRICE.TIMER_LORE", "§f정해진 시각마다 자동으로 다시 뽑음 (서버 시간 기준)");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD", "§f주기");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_LORE", "§f매일 / 매주 / 매월");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_DAILY", "매일");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_WEEKLY", "매주");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_MONTHLY", "매월");
            ccLang.get().addDefault("RANDOM_PRICE.HOUR", "§f시");
            ccLang.get().addDefault("RANDOM_PRICE.HOUR_LORE", "§f초기화 시각 (0~23)");
            ccLang.get().addDefault("RANDOM_PRICE.MINUTE", "§f분");
            ccLang.get().addDefault("RANDOM_PRICE.MINUTE_LORE", "§f초기화 분 (0~59)");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_WEEK", "§f요일");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_WEEK_LORE", "§f매주 초기화할 요일");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_MONTH", "§f날짜");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_MONTH_LORE", "§f매월 초기화할 날짜 (1~31)");
            ccLang.get().addDefault("RANDOM_PRICE.NEXT_RESET", "§f다음 초기화");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_1", "월요일");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_2", "화요일");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_3", "수요일");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_4", "목요일");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_5", "금요일");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_6", "토요일");
            ...
            ccLang.get().addDefault("ERR.MULTICURRENCY_NOT_FOUND", "MultiCurrency 플러그인을 찾을 수 없습니다.");
            ccLang.get().addDefault("ERR.MULTICURRENCY_UNKNOWN_CURRENCY", "MultiCurrency 화폐 '{currency}'이(가) 없거나 비활성화되어 있습니다.");
            ccLang.get().addDefault("MESSAGE.MC_BUY_SUCCESS", "§f{item} {amount}개를 {price}에 구매함. 잔액: {bal}");
            ccLang.get().addDefault("MESSAGE.MC_SELL_SUCCESS", "§f{item} {amount}개를 {price}에 판매함. 잔액: {bal}");
            ccLang.get().addDefault("MESSAGE.MC_NOT_ENOUGH", "§f잔액이 부족합니다. 가격: {price}");
            ccLang.get().addDefault("MESSAGE.MC_PAYMENT_FAILED", "§c결제를 처리할 수 없습니다 ({reason}). 청구된 금액은 없습니다.");
            ccLang.get().addDefault("MESSAGE.MC_OUTCOME_UNKNOWN", "§e결제 결과를 아직 확인할 수 없습니다. 자동으로 다시 확인하며, 이중으로 청구되지 않습니다.");
            ccLang.get().addDefault("MESSAGE.MC_SELL_FAILED", "§c대금을 지급할 수 없습니다 ({reason}). 아이템을 돌려드립니다.");
            ccLang.get().addDefault("MESSAGE.MC_ITEMS_DELIVERED", "§f결제가 완료된 구매품을 받았습니다: {item} {amount}개");
            ccLang.get().addDefault("MESSAGE.MC_ITEMS_RETURNED", "§f판매되지 않은 아이템을 돌려받았습니다: {item} {amount}개");
            ccLang.get().addDefault("MESSAGE.MC_REFUNDED", "§f전달할 수 없는 구매품의 대금 {price}을(를) 환불했습니다.");
            ccLang.get().addDefault("MESSAGE.MC_PRICE_TOO_LOW", "§f판매 금액이 너무 적어 지급할 수 없습니다.");
            ccLang.get().addDefault("MESSAGE.MC_PAYOUT_RECEIVED", "§f상점 계좌에서 {price}을(를) 받았습니다.");
        ...
        // 영어
        {
            ...
            ccLang.get().addDefault("SHOP.SELL_TAX_INFO", "§7({sign}tax {num}%)");
            ...
            ccLang.get().addDefault("RANDOM_PRICE.TITLE", "§3Random price");
            ccLang.get().addDefault("RANDOM_PRICE.BUTTON", "§fRandom price");
            ccLang.get().addDefault("RANDOM_PRICE.BUTTON_LORE", "§fRaise or lower prices by a random percent");
            ccLang.get().addDefault("RANDOM_PRICE.BACK", "§fBack");
            ccLang.get().addDefault("RANDOM_PRICE.BACK_LORE", "§f§nClick: Shop settings");
            ccLang.get().addDefault("RANDOM_PRICE.ENABLE", "§fUse random price");
            ccLang.get().addDefault("RANDOM_PRICE.ENABLE_LORE", "§fWhen on, every item gets a random percent");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET", "§fApply to");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_LORE", "§fBuy price, sell price or both");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_BUY", "Buy only");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_SELL", "Sell only");
            ccLang.get().addDefault("RANDOM_PRICE.TARGET_BOTH", "Buy and sell");
            ccLang.get().addDefault("RANDOM_PRICE.MIN", "§fMin percent");
            ccLang.get().addDefault("RANDOM_PRICE.MIN_LORE", "§fLowest value of the random range (negative = cheaper)");
            ccLang.get().addDefault("RANDOM_PRICE.MAX", "§fMax percent");
            ccLang.get().addDefault("RANDOM_PRICE.MAX_LORE", "§fHighest value of the random range");
            ccLang.get().addDefault("RANDOM_PRICE.REROLL", "§fReroll now");
            ccLang.get().addDefault("RANDOM_PRICE.REROLL_LORE", "§eClick: roll a new percent for every item");
            ccLang.get().addDefault("RANDOM_PRICE.REROLLED", "§fRandom prices rerolled. Shop: {shop}");
            ccLang.get().addDefault("RANDOM_PRICE.NOT_ENABLED", "§fRandom price is off for this shop. Shop: {shop}");
            ccLang.get().addDefault("RANDOM_PRICE.TIMER", "§fScheduled reset");
            ccLang.get().addDefault("RANDOM_PRICE.TIMER_LORE", "§fReroll automatically at a set time (server clock)");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD", "§fPeriod");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_LORE", "§fDaily / weekly / monthly");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_DAILY", "Daily");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_WEEKLY", "Weekly");
            ccLang.get().addDefault("RANDOM_PRICE.PERIOD_MONTHLY", "Monthly");
            ccLang.get().addDefault("RANDOM_PRICE.HOUR", "§fHour");
            ccLang.get().addDefault("RANDOM_PRICE.HOUR_LORE", "§fReset hour (0-23)");
            ccLang.get().addDefault("RANDOM_PRICE.MINUTE", "§fMinute");
            ccLang.get().addDefault("RANDOM_PRICE.MINUTE_LORE", "§fReset minute (0-59)");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_WEEK", "§fDay of week");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_WEEK_LORE", "§fWeekday to reset on");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_MONTH", "§fDay of month");
            ccLang.get().addDefault("RANDOM_PRICE.DAY_OF_MONTH_LORE", "§fDay of the month to reset on (1-31)");
            ccLang.get().addDefault("RANDOM_PRICE.NEXT_RESET", "§fNext reset");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_1", "Monday");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_2", "Tuesday");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_3", "Wednesday");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_4", "Thursday");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_5", "Friday");
            ccLang.get().addDefault("RANDOM_PRICE.WEEKDAY_6", "Saturday");
            ...
            ccLang.get().addDefault("ERR.MULTICURRENCY_NOT_FOUND", "Could not find 'MultiCurrency'.");
            ccLang.get().addDefault("ERR.MULTICURRENCY_UNKNOWN_CURRENCY", "The MultiCurrency currency '{currency}' does not exist or is disabled.");
            ccLang.get().addDefault("MESSAGE.MC_BUY_SUCCESS", "§fBought {item} x{amount} for {price}. Balance: {bal}");
            ccLang.get().addDefault("MESSAGE.MC_SELL_SUCCESS", "§fSold {item} x{amount} for {price}. Balance: {bal}");
            ccLang.get().addDefault("MESSAGE.MC_NOT_ENOUGH", "§fNot enough balance. Price: {price}");
            ccLang.get().addDefault("MESSAGE.MC_PAYMENT_FAILED", "§cThe payment could not be processed ({reason}). Nothing was charged.");
            ccLang.get().addDefault("MESSAGE.MC_OUTCOME_UNKNOWN", "§eThe payment result is not known yet. It is checked again automatically and you will not be charged twice.");
            ccLang.get().addDefault("MESSAGE.MC_SELL_FAILED", "§cThe payment could not be made ({reason}). Your items are returned.");
            ccLang.get().addDefault("MESSAGE.MC_ITEMS_DELIVERED", "§fYou received a paid purchase: {item} x{amount}");
            ccLang.get().addDefault("MESSAGE.MC_ITEMS_RETURNED", "§fItems from a sale that was not paid were returned: {item} x{amount}");
            ccLang.get().addDefault("MESSAGE.MC_REFUNDED", "§fA purchase that could not be delivered was refunded: {price}");
            ccLang.get().addDefault("MESSAGE.MC_PRICE_TOO_LOW", "§fThe sale price is too low to be paid out.");
            ccLang.get().addDefault("MESSAGE.MC_PAYOUT_RECEIVED", "§fYou received {price} from a shop account.");
